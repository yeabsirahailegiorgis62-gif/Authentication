    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.5rem' }}>
      <div className="glass-card" style={{ width: '100%', maxWidth: '480px' }}>
        <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
          ...
          <h1 style={{ fontSize: '1.75rem', fontWeight: 700, marginBottom: '0.4rem' }}>Create Your Account</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="input-group" style={{ marginBottom: '0.5rem' }}>
            <label htmlFor="password">Password (Minimum 12 characters)</label>
            <div style={{ position: 'relative' }}>
              <input
                id="password"
                type="password"
        ...
        <div style={{ display: 'flex', alignItems: 'center', margin: '1.5rem 0', color: 'var(--text-muted)', fontSize: '0.8rem' }}>
          ...
          <span style={{ padding: '0 0.75rem' }}>OR REGISTER WITH</span>
          <div style={{ flex: 1, height: '1px', background: 'var(--border-color)' }} />
        </div>
